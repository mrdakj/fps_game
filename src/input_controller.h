...
public:
  ...
  virtual void process_inputs(float current_time) {}
  virtual void process_inputs_keyboard(float current_time) {}
  virtual void process_inputs_mouse(float current_time) {}
  ...
  bool is_mouse_button_pressed(MouseButton button) const {
    return glfwGetMouseButton(m_window, static_cast<std::underlying_type<MouseButton>::type>(button)) == GLFW_PRESS;
  }
